  ...
  const pricingPlans: PricingPlan[] = [
    {
      ...
      description: "Ideal for small businesses or individual recruiters.",
      features: [
        "1 license",
        "ATS integration",
        "5K applications",
    ...
    },
    {
      ...
      price: "9,990€",
      priceIntervalName: "/year",
      description: "Perfect for growing teams or medium-sized businesses.",
      features: [
        "5 licenses",
        "ATS integration",
        "20K applications",
    ...
    },
    {
      ...
      priceIntervalName: "/year",
      description:
        "Customized solutions for large enterprises or specific needs.",
      features: [
        "Custom license quantity",
        "ATS integration",
      ...
      <div class="flex flex-col h-full">
        ...
        <div class="pt-8">
          ...
          <div class="mt-6 pt-4 flex-1 flex flex-row items-center">
            ...
            {:else}
              <a href={plan.link} class="btn btn-primary w-[80%] mx-auto">
