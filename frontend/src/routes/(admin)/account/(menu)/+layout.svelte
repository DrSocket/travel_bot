...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-content">
    <div class="navbar bg-base-100 lg:hidden">
      <div class="flex-1">
        <a class="btn btn-ghost normal-case text-xl" href="/">Semantik Match</a>
      </div>
      <div class="flex-none">
  ...
  <div class="drawer-side">
    ...
    <ul class="menu h-full p-2 w-48 bg-base-100 lg:border-r text-primary">
      <li>
        <div
          class="normal-case menu-title text-sm font-bold text-primary flex flex-row mb-4"
        >
          <a href="/" class="grow">Semantik Match</a>
      ...
      <li class="">
        <a
          href="/account/jobs"
          class={adminSection === "jobs" ? "active" : ""}
          on:click={closeDrawer}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <a
          ...
          on:click={closeDrawer}
        >
          <svg class="h-4 w-4" viewBox="0 0 24 24" stroke="none" fill="none">
      ...
      <li class="mt-auto">
        <a href="/account/sign_out" class="mt-auto text-xs">Sign Out</a>
      </li>
    </ul>
  </div>
</div>
